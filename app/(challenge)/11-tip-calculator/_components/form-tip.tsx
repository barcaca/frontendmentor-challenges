                        ...
                        <FormItem key={value} className="space-y-0">
                          ...
                          <FormLabel
                            ...
                            className={cn(
                              ...
                              'h-12 w-full bg-[#00494d] font-bold text-white text-xl hover:bg-[#26c0ab] peer-checked:text-[#00494d] peer-data-[state=checked]:bg-[#26c0ab] peer-data-[state=checked]:text-[#00494d]'
                            )}
                          >
                            {value}%
                          </FormLabel>
