...
Esta é uma solução para o [Frontend Mentor - Social Links Profile](https://www.frontendmentor.io/challenges/social-links-profile-UG32l9m6dQ)
# Indice
...
![Thumbnail](/assets/3-social-profile/3-thumbnail.png)
...
## 🏆 Conclusão
O desafio Social Links Profile do Frontend Mentor é ideal para praticar a criação de layouts simples e responsivos, focando na organização de links de redes sociais de forma limpa e intuitiva. Ele ajuda a aprimorar habilidades com flexbox, tipografia, e estilização de botões.
