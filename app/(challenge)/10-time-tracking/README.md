...
Esta é uma solução para o [Frontend Mentor - Time Tracking Dashboard](https://www.frontendmentor.io/challenges/time-tracking-dashboard-UIQ7167Jw)
...
![Thumbnail](/assets/10-time-tracking/10-thumbnail.png)

## 🔗 Links

- [Live Site URL](https://frontendmentor-libarcaca.vercel.app/10-time-tracking)
## 🛠️ Tecnologias
...
## 🏆 Conclusão
O desafio Time Tracking Dashboard do Frontend Mentor é uma excelente oportunidade para praticar a construção de interfaces dinâmicas, componentes reutilizáveis e praticar o consumo de dados dinâmicos a partir de um arquivo JSON. Além disso, é um excelente exercício para trabalhar a exibição de informações de forma clara e intuitiva.
