...
Esta é uma solução para o [Frontend Mentor - Article Preview](https://www.frontendmentor.io/challenges/article-preview-component-dYBN_pYFT)
# Indice
...
![Thumbnail](/assets/8-article-preview/8-thumbnail.png)

## 🔗 Links

- [Live Site URL](https://frontendmentor-libarcaca.vercel.app/8-article-preview)
## 🛠️ Tecnologias
...
## 🏆 Conclusão
O desafio Article Preview do Frontend Mentor é uma ótima oportunidade para aprimorar habilidades em posicionamento de elementos, interatividade com hover e uso de popover para exibir informações
