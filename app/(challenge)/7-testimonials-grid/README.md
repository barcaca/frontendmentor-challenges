...
Esta é uma solução para o [Frontend Mentor - Testimonials Grid](https://www.frontendmentor.io/challenges/testimonials-grid-section-Nnw6J7Un7)
# Indice
...
![Thumbnail](/assets/7-testimonials-grid/7-thumbnail.png)

## 🔗 Links

- [Live Site URL](https://frontendmentor-libarcaca.vercel.app/7-testimonials-grid)
## 🛠️ Tecnologias
...
## 🏆 Conclusão
O desafio Testimonials Grid do Frontend Mentor é uma excelente oportunidade para praticar a criação de layouts complexos e responsivos, utilizando CSS Grid para organizar depoimentos de forma equilibrada e visualmente atraente. 
