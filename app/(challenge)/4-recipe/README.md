...
Esta é uma solução para o [Frontend Mentor - Recipe Page](https://www.frontendmentor.io/challenges/recipe-page-KiTsR8QQKm)
# Indice
...
![Thumbnail](/assets/4-recipe/4-thumbnail.png)
...
## 🏆 Conclusão
O desafio Recipe Page do Frontend Mentor é uma excelente oportunidade para praticar a criação de layouts mais estruturados, focando na organização de conteúdo textual e visual.
